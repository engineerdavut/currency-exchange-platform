  ...
  return (
    <Card className="hover:shadow-lg transition-shadow">
      <div className="flex flex-col h-full">
        <div className="mb-4">
          <h3 className="text-xl font-semibold text-blue-600">{account.currencyType}</h3>
          <p className="text-gray-700 mt-2">
            <span className="font-medium">Balance:</span> {formatCurrency(account.balance, account.currencyType)}
          </p>
        </div>
