...
public class ExchangeResponseDto {
    ...
    public ExchangeResponseDto(String status, String message, BigDecimal executedPrice, LocalDateTime timestamp, BigDecimal fromAmount, String fromCurrency, BigDecimal toAmount, String toCurrency) {
        this.status = status;
